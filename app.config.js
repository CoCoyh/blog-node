...
exports.APP = {
	...
	ROOT_PATH: __dirname,
	NAME: 'coco',
	URL: 'http://coco.cn/main.html',
	FRONT_END_PATH: path.join(__dirname, '..', 'coco'),
};

exports.CROSS_DOMAIN = {
	allowedOrigins: [
		'http://coco.cn/main.html',
		'http://coco.cn',
		'https://github.com/coco',
	],
	allowedReferer: 'coco',
};
...
exports.EMAIL = {
	account: argv.email_account || 'your email address like : i@coco',
	password: argv.email_password || 'your email password',
	from: 'https://github.com/coco',
	admin: 'coco',
};

exports.AKISMET = {
	key: argv.akismet_key || 'your akismet Key',
	blog: argv.akismet_blog || 'your akismet blog site, like: http://coco.cn/main.html',
};
...
exports.GITHUB = {
	...
	// // 生产环境
  // redirect_url: 'http://coco.cn/login',
  // client_id: '*****',
	// client_secret: '*****',
...
exports.BAIDU = {
	site: argv.baidu_site || 'your baidu site domain like : coco',
